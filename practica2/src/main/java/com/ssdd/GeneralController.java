	  ...
	  @PostConstruct
	    public void init() {
		  try {
	    	...
	    	Vuelo v3 = new Vuelo("IB3333", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("18:00:00"), 60, 445, iberia, barajas, josep);
	    	...
	    	Vuelo v5 = new Vuelo("RY5555", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("23:00:00"), 60, 245, ryanair, barajas, josep);
	    	...
	    	Vuelo v7 = new Vuelo("RY7777", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("15:00:00"), 60, 230, ryanair, josep, barajas);
	    	...
	    	Vuelo v9 = new Vuelo("IB9999", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("21:00:00"), 60, 345, iberia, josep, barajas);
	    	...
	    	Vuelo v12 = new Vuelo("VY1313", new Date(fecha.parse("09/06/2020").getTime()), Time.valueOf("15:00:00"), 60, 245, vueling, barajas, manises);
	    	...
	    	Vuelo v14 = new Vuelo("IB1515", new Date(fecha.parse("09/06/2020").getTime()), Time.valueOf("21:00:00"), 60, 330, iberia, barajas, manises);
	    	...
	    	//Valencia-Madrid
	    	Vuelo v16 = new Vuelo("IB1717", new Date(fecha.parse("09/06/2020").getTime()), Time.valueOf("10:00:00"), 60, 345, iberia, manises, barajas);
	    	...
	    	Vuelo v18 = new Vuelo("IB1919", new Date(fecha.parse("09/06/2020").getTime()), Time.valueOf("18:00:00"), 60, 445, iberia, manises, barajas);
	    	...
	    	Vuelo v20 = new Vuelo("VY2121", new Date(fecha.parse("09/06/2020").getTime()), Time.valueOf("23:00:00"), 60, 145, vueling, manises, barajas);
	    	...
	    	Vuelo v22 = new Vuelo("AF2424", new Date(fecha.parse("25/08/2020").getTime()), Time.valueOf("15:00:00"), 120, 245, airFrance, barajas, charles);
	    	...
	    	Vuelo v24 = new Vuelo("IB2626", new Date(fecha.parse("25/08/2020").getTime()), Time.valueOf("21:00:00"), 120, 330, iberia, barajas, charles);
	    	...
	    	//París-Madrid
	    	Vuelo v26 = new Vuelo("IB2828", new Date(fecha.parse("25/08/2020").getTime()), Time.valueOf("10:00:00"), 120, 345, iberia, charles, barajas);
	    	...
	    	Vuelo v28 = new Vuelo("IB3030", new Date(fecha.parse("25/08/2020").getTime()), Time.valueOf("18:00:00"), 120, 445, iberia, charles, barajas);
	    	...
	    	Vuelo v30 = new Vuelo("AF3232", new Date(fecha.parse("25/08/2020").getTime()), Time.valueOf("23:00:00"), 120, 145, airFrance, charles, barajas);
	    	...
	    	Vuelo v32 = new Vuelo("AF3535", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("15:00:00"), 120, 245, airFrance, josep, charles);
	    	...
	    	Vuelo v34 = new Vuelo("IB3737", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("21:00:00"), 120, 330, iberia, josep, charles);
	    	...
	    	//París-Barcelona
	    	Vuelo v36 = new Vuelo("IB1111", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("10:00:00"), 120, 345, iberia, charles, josep);
	    	...
	    	Vuelo v38 = new Vuelo("IB3333", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("18:00:00"), 120, 445, iberia, charles, josep);
	    	...
	    	Vuelo v40 = new Vuelo("AF3232", new Date(fecha.parse("30/07/2020").getTime()), Time.valueOf("23:00:00"), 120, 145, airFrance, charles, josep);
	    	...
	    	Vuelo v42 = new Vuelo("VY3535", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("15:00:00"), 180, 245, vueling, barajas, heathrow);
	    	...
	    	Vuelo v44 = new Vuelo("IB3737", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("21:00:00"), 180, 330, iberia, barajas, heathrow);
	    	...
	    	//Londres-Madrid
	    	Vuelo v46 = new Vuelo("IB3939", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("10:00:00"), 180, 345, iberia, heathrow, barajas);
	    	...
	    	Vuelo v48 = new Vuelo("IB4141", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("18:00:00"), 180, 445, iberia, heathrow, barajas);
	    	...
	    	Vuelo v50 = new Vuelo("VY4343", new Date(fecha.parse("30/06/2020").getTime()), Time.valueOf("23:00:00"), 180, 145, vueling, heathrow, barajas);
	    	...
	    	Vuelo v52 = new Vuelo("RY4646", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("15:00:00"), 180, 345, ryanair, josep, heathrow);
	    	...
	    	Vuelo v54 = new Vuelo("IB4848", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("21:00:00"), 180, 330, iberia, josep, heathrow);
	    	...
	    	//Londres-Barcelona
	    	Vuelo v56 = new Vuelo("IB5050", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("10:00:00"), 180, 345, iberia, heathrow, josep);
	    	...
	    	Vuelo v58 = new Vuelo("IB5252", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("18:00:00"), 180, 445, iberia, heathrow, josep);
	    	...
	    	Vuelo v60 = new Vuelo("RY5454", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("23:00:00"), 180, 245, ryanair, heathrow, josep);
	    	...
	    	Vuelo v62 = new Vuelo("RY5757", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("15:00:00"), 240, 445, ryanair, barajas, kennedy);
	    	...
	    	Vuelo v64 = new Vuelo("IB5959", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("21:00:00"), 240, 430, iberia, barajas, kennedy);
	    	...
	    	//Nueva York - Madrid
	    	Vuelo v66 = new Vuelo("IB6161", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("10:00:00"), 240, 545, iberia, kennedy, barajas);
	    	...
	    	Vuelo v68 = new Vuelo("IB6363", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("18:00:00"), 240, 645, iberia, kennedy, barajas);
	    	...
	    	Vuelo v70 = new Vuelo("RY6565", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("23:00:00"), 240, 345, ryanair, kennedy, barajas);
	    	...
	    	Vuelo v72 = new Vuelo("VY6868", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("15:00:00"), 240, 445, vueling, josep, kennedy);
	    	...
	    	Vuelo v74 = new Vuelo("IB7070", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("21:00:00"), 240, 430, iberia, josep, kennedy);
	    	...
	    	Vuelo v76 = new Vuelo("IB7272", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("10:00:00"), 240, 545, iberia, kennedy, josep);
	    	...
	    	Vuelo v78 = new Vuelo("IB7474", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("18:00:00"), 240, 645, iberia, kennedy, josep);
	    	...
	    	Vuelo v80 = new Vuelo("VY7676", new Date(fecha.parse("03/07/2020").getTime()), Time.valueOf("23:00:00"), 240, 320, vueling, kennedy, josep);
	    	...
	    	Vuelo v82 = new Vuelo("LA7979", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("15:00:00"), 300, 445, latam, barajas, josemarti);
	    	...
	    	Vuelo v84 = new Vuelo("IB8181", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("21:00:00"), 300, 430, iberia, barajas, josemarti);
	    	...
	    	//La Habana-Madrid
	    	Vuelo v86 = new Vuelo("IB8383", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("10:00:00"), 300, 545, iberia, josemarti, barajas);
	    	...
	    	Vuelo v88 = new Vuelo("IB8585", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("18:00:00"), 300, 745, iberia, josemarti, barajas);
	    	...
	    	Vuelo v90 = new Vuelo("LA8787", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("23:00:00"), 300, 345, latam, josemarti, barajas);
	    	...
	    	Vuelo v92 = new Vuelo("LA9090", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("15:00:00"), 300, 445, latam, josep, josemarti);
	    	...
	    	Vuelo v94 = new Vuelo("LA9292", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("21:00:00"), 300, 430, latam, josep, josemarti);
	    	...
	    	//La Habana-Barcelona
	    	Vuelo v96 = new Vuelo("IB9494", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("10:00:00"), 300, 545, iberia, josemarti, josep);
	    	...
	    	Vuelo v98 = new Vuelo("IB9696", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("18:00:00"), 300, 745, iberia, josemarti, josep);
	    	...
	    	Vuelo v100 = new Vuelo("LA9898", new Date(fecha.parse("01/12/2020").getTime()), Time.valueOf("23:00:00"), 300, 345, latam, josemarti, josep);
